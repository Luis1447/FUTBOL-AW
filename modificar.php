	...
	if(isset($_POST["btn-form"])){
		...
		if ($conn->connect_error) {
			die("Connexió KO: " . $conn->connect_error);
				...
				$sql = "UPDATE equips SET nom='".$nom . "', localitat='" . $localitat . "', web='" . $web . "', escut='". $escut . "' WHERE codi='".$codi."'";
...
<html>
	...
	<nav class="navbar navbar-dark bg-primary">
		...
		<form  name="formulari1" method="POST" action="modificar.php">
		  <div class="form-group">
    <label>Codi</label>
    <input type="text" class="form-control" name="codi" placeholder="codigo del equipo que quieres modificar">
  </div>
  <div class="form-group">
    <label>Nom</label>
