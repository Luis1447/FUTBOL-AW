...
<html>
	...
	<nav class="navbar navbar-dark bg-primary">
		...
		<form  name="formulari1" method="POST" action="eliminar.php">
  <div class="form-group">
    <label>Intruduce el codigo del equipo que desea eliminar</label>
    <input type="text" class="form-control" name="codi" placeholder="codigo del equipo">
  </div>
